            ...
            children: [
              ...
              Center(
                child: TextButton(
                  ...
                  style: ButtonStyle(
                    padding:
                        WidgetStateProperty.all(EdgeInsets.symmetric(horizontal: 15, vertical: 5)),
                    backgroundColor: WidgetStateProperty.all(
                        myLoading.isDark ? ColorRes.colorPrimary
                        : ColorRes.greyShade100),
      ...
      child: Row(
        children: [
          ...
          Switch(
            ...
            thumbColor: WidgetStateProperty.all(isOn ? ColorRes.colorPink : ColorRes.greyShade100),
          )
        ],
      ),
    );
